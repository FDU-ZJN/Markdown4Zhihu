...
>
>  ![img](https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/Transformer学习/v2-f6380627207ff4d1e72addfafeaff0bb_1440w.jpg)
>
...
![img](https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/Transformer学习/v2-b0a11f97ab22f5d9ebc396bc50fa9c3f_1440w.jpg)
...
![img](https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/Transformer学习/v2-8b442ffd03ea0f103e9acc37a1db910a_1440w.jpg)

这样做能利用序列的顺序和位置关系（毕竟狗咬人和人咬狗肯定不一个意思）

## self-attention

<img src="https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/Transformer学习/v2-6444601b4c41d99e70569b0ea388c3bd_1440w.jpg" alt="img" style="zoom:50%;" />
...
-  Matmul2：将注意力权重与值向量 V 相乘
   ...
   ![image-20251122215913218](https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/Transformer学习/image-20251122215913218.png)
...
<img src="https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/Transformer学习/v2-b0ea8f5b639786f98330f70405e94a75_1440w.jpg" alt="img" style="zoom: 33%;" />
...
![img](https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/Transformer学习/v2-35d78d9aa9150ae4babd0ea6aa68d113_1440w.jpg)
...
![image-20251123160819131](https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/Transformer学习/image-20251123160819131.png)

### Feed Forward

两层的全连接，第一层加Relu。

![img](https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/Transformer学习/v2-47b39ca4cc3cd0be157d6803c8c8e0a1_1440w.jpg)

通过线性变换，先将数据映射到高纬度的空间再映射到低纬度的空间，提取了更深层次的特征。（一个博客的说法）

### 结构

<img src="https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/Transformer学习/v2-45db05405cb96248aff98ee07a565baa_1440w.jpg" alt="img" style="zoom:33%;" />六层Encoder Block串联组成整个Encoder。

## Decoder整体

<img src="https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/Transformer学习/image-20251123162011036.png" alt="image-20251123162011036" style="zoom: 50%;" />包含两个 Multi-Head Attention 层, K,V由Encoder提供，**Q**使用上一个 Decoder block 的输出计算

### 第一个Multi-Head Attention

![img](https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/Transformer学习/v2-4616451fe8aa59b2df2ead30fa31dc98_1440w.jpg)

使用了前面说的Mask,就像你在做翻译时，可以看你前面翻译好的词，但不能看后面未来的作弊。

计算就是在softmax前挡一下就行

![img](https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/Transformer学习/v2-35d1c8eae955f6f4b6b3605f7ef00ee1_1440w.jpg)
...
![img](https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/Transformer学习/v2-0938aa45a288b5d6bef6487efe53bd9d_1440w.jpg)
