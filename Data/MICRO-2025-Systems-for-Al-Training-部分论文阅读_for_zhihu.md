...
![image-20251022081259452](https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/MICRO-2025-Systems-for-Al-Training-部分论文阅读/image-20251022081259452.png)
...
![image-20251027090838491](https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/MICRO-2025-Systems-for-Al-Training-部分论文阅读/image-20251027090838491.png)
...
![image-20251026175746443](https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/MICRO-2025-Systems-for-Al-Training-部分论文阅读/image-20251026175746443.png)

>  一篇分析**大规模分布式大语言模型训练**性能、功耗与热行为的论文，研究方法感觉不需要太关注，它的结论还是比较有意思的，感觉是面向特别大规模计算中心的，估计自己这辈子都没机会用上(˘•ω•˘)

## 扩展策略（Scale-up vs. Scale-out）

![image-20251026180929133](https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/MICRO-2025-Systems-for-Al-Training-部分论文阅读/image-20251026180929133.png)
...
-  EP的All-to-All更是如此，会制造巨大的跨节点通信洪流。
   ![image-20251026185826939](https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/MICRO-2025-Systems-for-Al-Training-部分论文阅读/image-20251026185826939.png)
...
>
>  ![image-20251026185705673](https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/MICRO-2025-Systems-for-Al-Training-部分论文阅读/image-20251026185705673.png)
>
>  
...
![image-20251026190714254](https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/MICRO-2025-Systems-for-Al-Training-部分论文阅读/image-20251026190714254.png)

## 热不平衡

-  服务器前后GPU因气流不均存在显著温差（最高达27%）。

   ![image-20251026191805343](https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/MICRO-2025-Systems-for-Al-Training-部分论文阅读/image-20251026191805343.png)
...
![image-20251026192901357](https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/MICRO-2025-Systems-for-Al-Training-部分论文阅读/image-20251026192901357.png)
...
![image-20251029135026682](https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/MICRO-2025-Systems-for-Al-Training-部分论文阅读/image-20251029135026682.png)
...
![image-20251029135934530](https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/MICRO-2025-Systems-for-Al-Training-部分论文阅读/image-20251029135934530.png)

上述这些方法虽然减少了通信数据量，但引入了**显著的计算开销**（用于压缩、索引或重建） 。在早期的低带宽网络中，这些开销是值得的。但在现代HPC系统的高带宽（如16 GBps）环境下，**这些计算开销本身成为了新的瓶颈**，甚至抵消了通信节省带来的好处 。

![image-20251029141455729](https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/MICRO-2025-Systems-for-Al-Training-部分论文阅读/image-20251029141455729.png)
...
![image-20251029191104645](https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/MICRO-2025-Systems-for-Al-Training-部分论文阅读/image-20251029191104645.png)
...
![image-20251029192912960](https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/MICRO-2025-Systems-for-Al-Training-部分论文阅读/image-20251029192912960.png)
...
![image-20251029193046136](https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/MICRO-2025-Systems-for-Al-Training-部分论文阅读/image-20251029193046136.png)

### 跳过 Reduce-Scatter (RS) 与 AllGather (AG) 的权衡

![image-20251029193359456](https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/MICRO-2025-Systems-for-Al-Training-部分论文阅读/image-20251029193359456.png)
...
![image-20251031091603164](https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/MICRO-2025-Systems-for-Al-Training-部分论文阅读/image-20251031091603164.png)
...
![image-20251030100940440](https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/MICRO-2025-Systems-for-Al-Training-部分论文阅读/image-20251030100940440.png)
...
![image-20251030104108200](https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/MICRO-2025-Systems-for-Al-Training-部分论文阅读/image-20251030104108200.png)
...
![image-20251030204749486](https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/MICRO-2025-Systems-for-Al-Training-部分论文阅读/image-20251030204749486.png)
...
![image-20251030213729928](https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/MICRO-2025-Systems-for-Al-Training-部分论文阅读/image-20251030213729928.png)
...
![image-20251030215012209](https://cdn.statically.io/gh/FDU-ZJN/Markdown4Zhihu/master/Data/MICRO-2025-Systems-for-Al-Training-部分论文阅读/image-20251030215012209.png)
